...
import InterState from './LogisticsComponents/InterState';
import Local from './LogisticsComponents/Local';
import International from './LogisticsComponents/International';
  ...
  return (
    <>
          ...
          <div className={`${styles.product_actions} d-md-flex justify-content-between`}>
            <div className=" ">
              ...
              <p style={{ fontSize: '14px' }} className={`mb-0 mt-2 pb-0`}>
               Add and assign drivers to your shipment area
              </p>
          ...
          <TabContext value={value}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <TabList aria-label="lab API tabs" onChange={handleChange}>
                ...
                <Tab label="International" value="3" />
              </TabList>
            </Box>
      ...
      <Modal
        ...
        disableEnforceFocus
      >
        <Fade in={createRoute} style={{maxWidth: '95%'}}>
          <Box sx={style} className={`mobile_modal_size bg-white`}>
            ...
            >
              ...
              <div className="mt-4 mb-2">
                ...
                <input type="text" placeholder="Imo" style={{ width: '100%' }} className=" form-control" />
              ...
              <div className="mt-3 mb-2">
                ...
                <div className={`${styles.charges_input}`}> 
                  <span>$</span>
                  <input type="number" placeholder="" style={{ width: '100%', textIndent: '25px' }} className=" form-control" />
              ...
              <div className='d-block w-100 mt-4 pt-3'><button className='d-block w-100 btn py-2 text-white' onClick={handleCloseCreateRoute} style={{background: '#00AF52'}}>Save</button></div>
