            ...
            <div className="d-md-flex justify-content-between" >
              <div className="pb-3 pb-md-0">
                ...
                <small style={{ fontWeight: 'normal', fontSize: '14px' }}>
                  Create time slots, assign drivers to routes
                </small>
                ...
                <tbody>
                  ...
                  <tr className={`${styles.tr} `}>
                    ...
                    <td className="text-center">
                      <span className="btn py-3 d-block" onClick={() => setdriversList(true)} >
                        4
                      </span>
                    </td>
                    <td className="text-center">
          ...
          <Box sx={style} className={`mobile_modal_size`}>
            ...
            >
              <div className={`modal_header mb-0`}>
                ...
                <span onClick={handleClosedriversList} style={{ cursor: 'pointer' }}>
                  <img src="/assets/icons/x.svg" alt="" />
              ...
              <p className=' mt-0' style={{
                ...
                <span className="m-0 d-block text-muted font-weight-normal">Details of Vehicle</span>
                {/* <small className="m-0 d-block">Bus 001</small> */}
              </p>

              <div className="mt-4 modal_content" style={{ maxHeight: '300px', overflowY: 'scroll' }}>
