                    ...
                    <CardContent>
                        <div className={`${styles.insight_header} pl-md-5`}>
                            ...
                            <div className="d-md-flex flex-wrap justify-content-between mt-md-0 mt-4 pt-2" style={{ alignItems: 'center', gap: '15px' }}>
                                ...
                                <div className="">
                                    <div className="card  p-0 " style={{ minWidth: '16em' }} >
                                        <div className="card-body d-flex justify-content-around pb-0 pt-2">
                                            <div className='d-inline m-0'>  
                                                <input type="radio"
                                                    id="tabbs"
                                                    name="tabsss"
                                    ...
                                    <div className="d-md-flex">
                                        <div className="">
                                            <div className="card p-0" style={{ minWidth: '20em', height: '35px' }}  >
                                                <div className="card-body d-flex justify-content-around  py-1" style={{ whiteSpace: 'nowrap' }}>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="ov2" />
                                                        <label htmlFor="ov2">
                                                            Overall
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="year2" />
                                                        <label htmlFor="year2">
                                                            Yearly
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="month2" />
                                    ...
                                    <div className="d-md-flex">
                                        <div className="">
                                            <div className="card p-0" style={{ minWidth: '20em', height: '35px' }}  >
                                                <div className="card-body d-flex justify-content-around  py-1" style={{ whiteSpace: 'nowrap' }}>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="ov3" />
                                                        <label htmlFor="ov3">
                                                            Overall
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="year3" />
                                                        <label htmlFor="year3">
                                                            Yearly
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="month3" />
                                    ...
                                    <div className="d-md-flex ">
                                        <div className="">
                                            <div className="card p-0" style={{ minWidth: '20em', height: '35px' }}  >
                                                <div className="card-body d-flex justify-content-around  py-1" style={{ whiteSpace: 'nowrap' }}>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="ov4" />
                                                        <label htmlFor="ov4">
                                                            Overall
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="year4" />
                                                        <label htmlFor="year4">
                                                            Yearly
                                                        </label>
                                                    </div>
                                                    <div className='d-inline m-0'>
                                                        <input className="" type="radio" name="insight_depletion" id="month4" />
                                                        <label htmlFor="month4">
                                                            Monthly
                                                        </label>
                                                    </div>
                                                </div>
