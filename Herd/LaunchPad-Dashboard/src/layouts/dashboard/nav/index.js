...
export default function Nav({ openNav, onCloseNav }) {
  ...
  const switchDashboard = () => {
    const type = (!auth.type) || auth.type ==='transport' ? 'logistic' : 'transport'

    localStorage.setItem("auth", JSON.stringify({type}))
