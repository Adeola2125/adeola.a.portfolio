...
<template>
  <VNavigationDrawer :rail-width="drawerProps.railWidth" :rail="drawerProps.rail" :border="true" :elevation="1">
    <VToolbar class="px-3" color="transparent">
      <!-- <Logo :height="26" /> -->
      <div class="w-100 d-flex align-items-center ml-2 ml-sm-4 mr-1 mr-sm-2">
        <img src="/assets/images/logo/logo.png" height="60" alt="logo" />
      </div>
      <VToolbarTitle>Owo Kolo Challenge</VToolbarTitle>
    </VToolbar>
